  ...
  return (
    <div className="flex flex-col ">
      ...
      <div className="flex-1 flex">
        ...
        <main className="w-full overflow-y-auto h-[calc(100vh-5rem)]">
                ...
                >
                  <div className="sm:w-[350px] mx-auto">
                    <section>
                      ...
                      <div className="flex flex-col sm:flex-row gap-10 mt-5 text-sm">
                      ...
                      <div className="relative border-b border-b-black pb-2 sm:w-[200px] mt-5">
                        <select
                    ...
                    <section className="mt-8 text-sm flex flex-col gap-6">
                      ...
                      <p className="text-[orange] text-base font-medium mt-2">
