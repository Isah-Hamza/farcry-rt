    ...
    <>
        <div className='w-full flex flex-col relative'>
            ...
            <div className='absolute top-1 left-1/2 -translate-x-1/2 w-[90%] sm:w-[unset] md:w-[700px] bg-white bg-opacity-60 px-5 py-10 sm:p-10'>
                ...
                <p className='text-center'>We are here for you. Please fill the form below</p>
                <div className='flex flex-col gap-5 mt-10 sm:w-[400px] mx-auto'>
                    ...
                    <div className='flex items-end gap-3 border-b border-b-black pb-2 mt-5'>
                        ...
                        <input id='phone' name='phone' className='bg-transparent w-full outline-none border-none pl-4' type='text' placeholder='Your phone number' />
                    </div>
                    <div className='flex items-end gap-3 border-b border-b-black pb-2 mt-5'>
                        <label className='text-sm font-medium' htmlFor='location'>Location:</label>
                        <input id='location' name='location' className='bg-transparent w-full outline-none border-none ' type='text' placeholder='Enter your location number' />
                    </div>
                    ...
                    <div className='flex items-center gap-7'>
                        <button className='px-12 sm:px-16 py-3 rounded-md text-white bg-[#f59134] shadow-md'>Submit</button>
